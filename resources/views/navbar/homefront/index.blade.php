...
@section('content')
  <main id="main">
    ...
    <section id="hero" class="hero">
      ...
      <img src="{{asset('assetsfront/img/home1.jpg')}}" alt="" data-aos="fade-in">

      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <h2 data-aos="fade-up" data-aos-delay="100">Welcome to LiftUp</h2>
            <p data-aos="fade-up" data-aos-delay="200">A Comprehensive Car Recovery Solution</p>
          </div>
          <div class="col-lg-5">
      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('assetsfront/img/clients/client-1.png')}}" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('assetsfront/img/clients/client-2.png')}}" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('assetsfront/img/clients/client-3.png')}}" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('assetsfront/img/clients/client-4.png')}}" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('assetsfront/img/clients/client-5.png')}}" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('assetsfront/img/clients/client-6.png')}}" class="img-fluid" alt="">
          </div><!-- End Client Item -->
    ...
    <section id="stats" class="stats">
      ...
      <img src="{{asset('assetsfront/img/stats-bg.jpg')}}" alt="" data-aos="fade-in">
